                    ...
                    <li class="well">${soalItem.pertanyaan}<br/>
                        <ul class="nav">
                            ...
                            <li>
                                ...
                                C<form:radiobutton checked="${cek}" path="" name="jawaban${nomor}"
                                                   value="${soalItem.jawabans[2].id}"
                                                   label="${soalItem.jawabans[2].pilihan}"
                            ...
                            <li>
                                ...
                                D<form:radiobutton checked="${cek}" path="" name="jawaban${nomor}"
                                                   value="${soalItem.jawabans[3].id}"
                                                   label="${soalItem.jawabans[3].pilihan}"
